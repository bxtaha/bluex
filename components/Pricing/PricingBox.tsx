const PricingBox = (props: {
  ...
  return (
    <div className="w-full">
      <div
        className="wow fadeInUp relative z-10 rounded-lg bg-white px-8 py-10 shadow-three hover:shadow-one dark:bg-gray-dark dark:shadow-two dark:hover:shadow-gray-dark"
        data-wow-delay=".1s"
      >
