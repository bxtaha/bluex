      ...
      <div className='Toastify__toast-container Toastify__toast-container--bottom-center'>
        <div className='Toastify__toast Toastify__toast--warning'>
          <div role='alert' className='Toastify__toast-body'>
            <i className='bx bx-info-circle'></i> Some functions may not work
            because of storefront vulnerability!
          </div>
          <div
          ...
          <ul className='navbar-nav ms-auto'>
            <li className='nav-item add-products'>
              <Link href='#' activeClassName='active'>
                <a className='nav-link' onClick={productSideModal}>
                  Add Products
                </a>
              </Link>
            </li>
            ...
            <li className='nav-item profile'>
              <Link href='#'>
                <a className='nav-link'>
                  <i className='bx bx-user '></i> {user && user.name}{' '}
                </a>
              </Link>
